...
namespace BIXOLON_SamplePg
{
    class BXLAPI
    {
        ...
        public const int BXL_CONNECT_FAIL			= -100;
        public const int BXL_NOT_OPENED				= -101;
        public const int BXL_NOT_SUPPORT		    = -107;
        public const int BXL_INVALID_PARAM			= -108;
        public const int BXL_BUFFER_ERROR			= -109;
        public const int BXL_NO_PRINT_DATA			= -110;
        public const int BXL_COMPLETE_ERROR			= -111;
        public const int BXL_NO_TRANSACTION_START	= -112;
        ...
        public const int BXL_BMP_LOAD_ERROR			= -400;
        public const int BXL_BMP_BUFFER_SIZE_ERROR	= -401;
        ...
        public const int BXL_STS_CASHDRAWER_LOW     = 512;

        //Presenter Status flag
        public const int BXL_PRT_STS_NORMAL         = 0;
        public const int BXL_PRT_STS_PAPER_NEAR_END = 1;
        public const int BXL_PRT_STS_PAPEREMPTY     = 4;
        public const int BXL_PRT_STS_PAPER_IN       = 8;
        public const int BXL_PRT_STS_PAPER_JAM      = 128;
        ...
        // Sereal Flow Control
        public const int BXL_SERIAL_DTR_DSR	    = 0;
        public const int BXL_SERIAL_XON_XOFF	= 1;
        public const int BXL_SERIAL_NONE		= 2;

        // Eject Options
        public const int BXL_EJT_NONE		= 0;
        public const int BXL_EJT_HOLD       = 1;
        ...
        public static int PrinterOpen(int nInterface, string szPortName, int nBaudRate, int nDataBits, int nParity, int nStopBits, int nFlowControl)
        {
            if (Is64Bit())
        ...
        public static int ConnectSerial(string szPortName, int nBaudRate, int nDataBits, int nParity, int nStopBits, int nFlowControl)
        {
            if (Is64Bit())
        ...
        public static int PrintTextInImage(string Data, string FontName, bool Italic, bool Bold, bool Underline, int FontSize, int Alignment)
        {
            if (Is64Bit())
        ...
        public static int PrintTextInImageW(string Data, string FontName, bool Italic, bool Bold, bool Underline, int FontSize, int Alignment)
        {
            if (Is64Bit())
        ...
        public static int PrintBitmapLZMA(string FileName, int Width, int Alignment, int Level, bool bDithering)
        {
            if (Is64Bit())
        ...
        public static int GetBitmapBuffer(string FileName, int Width, int Level, bool bDithering, Byte[] pOutBuffer, uint cbBuf, ref uint pcbNeeded)
        {
            if (Is64Bit())
        ...
        public static int PrintBarcode(string Data, int Symbology, int Height, int Width, int Alignment, int TextPosition)
        {
            if (Is64Bit())
        ...
        public static int PrintPDF417(string Data, int Type, int ColumnNumber, int RowNumber, int ModuleWidth, int ModuleHeight, int EccLevel, int Alignment)
        {
            if (Is64Bit())
        ...
        public static int PrintQRCode(string Data, int Model, int ModuleSize, int EccLevel, int Alignment)
        {
            if (Is64Bit())
        ...
        public static int PrintQRCodeW(string Data, int Model, int ModuleSize, int EccLevel, int Alignment)
        {
            if (Is64Bit())
        ...
        public static int GetPrinterFirmwareVersion(Byte[] pBuffer, ref int bufferInBytes)
        {
            if (Is64Bit())
        ...
        public static int getprinterModelName(Byte[] pBuffer, ref int bufferInBytes)
        {
            if (Is64Bit())
        ...
        public static int PaperEject(int option)
        {
            if (Is64Bit())
        ...
        public static int GetPresenterStatus()
        {
            if (Is64Bit())
        ...
        public static int SetPresenterLoop(bool enable)
        {
            if (Is64Bit())
        ...
        public static int DownloadPrinterFirmware(string fileName)
        {
            if (Is64Bit())
        ...
        public static int DownloadPrinterFirmwareW(string fileName)
        {
            if (Is64Bit())
